...
activities = {
    ...
    ,"Soccer Team": {
        "description": "Competitive soccer team practicing tactics and matches",
    ...
    "Drama Society": {
        "description": "Theatre productions, rehearsals, and stagecraft",
        "schedule": "Wednesdays and Saturdays, 4:00 PM - 7:00 PM",
        "max_participants": 25,
